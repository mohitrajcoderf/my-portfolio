...
export const PROFILES = {
    twitter: {
        title: 'X (Twitter)',
        username: 'mohitraj2546',
        url: 'https://twitter.com/intent/user?screen_name=mohitraj2546',
        icon: (
            <svg
    ...
    github: {
        title: 'GitHub',
        url: 'https://github.com/mohitrajcoderf',
    ...
    instagram: {
        title: 'Instagram',
        url: 'https://www.instagram.com/mohitraj.tsx',
